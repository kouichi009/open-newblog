<template>
  <div>
    ...
    <div style="font-size: 18px; width: 700px;" class="mx-auto ma-5">
      ...
      <p>
        Nakanishi City built the newBlog app as a Commercial app. This SERVICE
        is provided by Nakanishi City and is intended for use as is.
      </p>
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at newBlog unless otherwise
      ...
      <p>
        ...
        but not limited to email, name, phone number, address, bank account. The
      ...
      <p>This policy is effective as of 2021-06-23</p>
