<template>
  <div>
    <v-app-bar>
      <h1 @click="toHome" style="cursor: pointer;">Home</h1>
    </v-app-bar>
    <div style="font-size: 18px; width: 700px;" class="mx-auto ma-5">
      ...
      <p>
        Nakanishi City is committed to ensuring that the app is as useful and
      ...
      <p>
        The newBlog app stores and processes personal data that you have
        ...
        phone’s security features and it could mean that the newBlog app won’t
      ...
      <p>
        You should be aware that there are certain things that Nakanishi City
        ...
        can be Wi-Fi, or provided by your mobile network provider, but Nakanishi
        City cannot take responsibility for the app not working at full
      ...
      <p>
        Along the same lines, Nakanishi City cannot always take responsibility
        ...
        avail the Service, Nakanishi City cannot accept responsibility.
      </p>
      <p>
        With respect to Nakanishi City’s responsibility for your use of the app,
        ...
        make it available to you. Nakanishi City accepts no liability for any
      ...
      <p>
        ...
        to keep using the app. Nakanishi City does not promise that it will
      ...
      <p>
        These terms and conditions are effective as of 2021-06-23
      </p>
      <p><strong>Contact Us</strong></p>
      <p>
        If you have any questions or suggestions about our Terms and Conditions,
        do not hesitate to
        <a href="/help/contactus" target="_blank" rel="noopener noreferrer"
          >contact us</a
        >.
      </p>
      <p>
